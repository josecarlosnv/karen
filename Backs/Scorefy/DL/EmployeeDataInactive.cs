...
public partial class EmployeeDataInactive
{
    ...
    public DateOnly? SecondmentExpDate { get; set; }

    public DateOnly? ProjectExpDate { get; set; }

    public DateOnly? ContractExpDate { get; set; }

    public string? ClientFacing { get; set; }

    public decimal? PracticePorcentaje { get; set; }

    public decimal? EmployeePorcentaje { get; set; }
