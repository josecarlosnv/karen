...
public partial class Generale
{
    ...
    public string? IndustriaDesc { get; set; }

    public int? EventNumber { get; set; }

    public virtual FlujoAudit? FlujoAudit { get; set; }

    public virtual Industrium? Industria { get; set; }

    public virtual LocalReferidum? LocalReferida { get; set; }

    public virtual RiesgoCeac? RiesgoCeac { get; set; }

    public virtual Segmento? Segmento { get; set; }

    public virtual TipoRev? TipoRev { get; set; }
}
