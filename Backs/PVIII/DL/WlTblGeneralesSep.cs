...
public partial class WlTblGeneralesSep
{
    ...
    public int? LocalRefereridal { get; set; }

    public int PaisReferidalId { get; set; }
    ...
    public int? FlujoAuditdI { get; set; }

    public int? TipoRevld { get; set; }
