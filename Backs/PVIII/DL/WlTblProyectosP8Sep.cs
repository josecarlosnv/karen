...
public partial class WlTblProyectosP8Sep
{
    ...
    public int? LocalReferidadid { get; set; }

    public int? PaisReferidadid { get; set; }
    ...
    public bool? ReportGrupo { get; set; }
